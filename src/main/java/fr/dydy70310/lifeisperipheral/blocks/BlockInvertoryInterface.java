...
public class BlockInvertoryInterface extends BlockContainer implements IPeripheralProvider {
	
	
	
	public BlockInvertoryInterface() {
		super(Material.rock);
	...
	public IPeripheral getPeripheral(World world, BlockPos bpos, EnumFacing side) {
		...
		TileInvertoryInterface chest = new TileInvertoryInterface();
		chest.pos = bpos;
		chest.world = world;
		...
		if (tile == null)
			return null;
		if (tile instanceof TileInvertoryInterface) {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileInvertoryInterface();
	}
	@Override
