...
public class BlockChatInterface extends BlockContainer implements IPeripheralProvider {
	
	
	
	public BlockChatInterface() {
		super(Material.rock);
	...
	public IPeripheral getPeripheral(World world, BlockPos bpos, EnumFacing side) {
		...
		TileChatInterface chatInterface = new TileChatInterface();
		chatInterface.pos = bpos;
		chatInterface.world = world; 
		
		BlockPos pos1;
		if (tile == null)
			return null;
		if (tile instanceof TileChatInterface) {
