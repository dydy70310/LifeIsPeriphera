...
public class BlockWorldInterface extends BlockContainer implements IPeripheralProvider {
	...
	public IPeripheral getPeripheral(World world, BlockPos bpos, EnumFacing side) {
		...
		TileWorldInterface worldInterface = new TileWorldInterface();
		worldInterface.pos = bpos;
		worldInterface.world = world;
		
		BlockPos pos1;
		if (tile == null)
			return null;
		if (tile instanceof TileWorldInterface) {
